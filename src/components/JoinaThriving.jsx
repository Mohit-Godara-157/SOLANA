...
const JoinaThriving = () => {
  return (
    <div>
      <Container className="customContainer overflowXhidden">
        <h2
          data-aos="fade-up"
          data-aos-easing="ease-out-cubic"
          data-aos-duration="2000"
          className="mb-0 text-white text-center text-lg-start fs_xl mt-4 pt-2 pt-lg-0 ff_HelveticaNormal"
        >
          Join a thriving community.
        </h2>
      </Container>
      <div className=" position-relative  ">
        <Container className="customContainer lastBgImage pt-lg-4 pb-lg-5"></Container>
      </div>
      <Marquee speed={60}>
        <div className="d-grid gap-3 mt-4">
          ...
          <div className="box1 grid5 text-center d-flex align-items-center flex-column justify-content-center">
            <p className="mb-0 fs_4xl ff_HelveticaNormal text_green">48,000</p>
            <p className="mb-0 mt-2 text-uppercase ff_HelveticaNormal  fs_2xsm text_dark_90">
          ...
          <div className="box1 grid7 text-center d-flex align-items-center flex-column justify-content-center">
            <p className="mb-0 fs_4xl ff_HelveticaNormal text_yellow">3,800</p>
            <p className="mb-0 mt-2 text-uppercase ff_HelveticaNormal fs_2xsm text_dark_90">
              Solana Breakpoint 2022 attendees
            </p>
          </div>
          <div className="box2   grid8">
            <img className=" h-100 w-100 " src={image4} alt="image4" />
          </div>
        </div>
      </Marquee>
      <Container className="customContainer overflowXhidden ">
        <div className="text-center my-5 py-5">
          <p
            ...
            data-aos-easing="ease-out-cubic"
            data-aos-duration="2000"
            className="text-white ff_HelveticaNormal fs_xl"
          >
          ...
          <button
            ...
            data-aos-easing="ease-out-cubic"
            data-aos-duration="2000"
            className="text-white fs_3xsm text-uppercase startBtn ff_roboto fw-normal border-0"
          >
            Start building
          </button>
        </div>
